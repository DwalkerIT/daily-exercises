...
document.querySelector("#question1").innerHTML = "<h3>Make This Red Text</h3>";

document.querySelector("#question2").innerHTML =
  "<button>Make This a 1 button</button>";
("<button>Make This a 2 button</button>");
// "<button>Make This a 3 button</button>";
// "<button>Make This a 4 button</button>";
// "<button>Make This a 5 button</button>";


const boxes [null, null, null, null, null]

const boxesHtmlList = boxes.map((item) => `<div class="box></div>`)

document.querySelector("#question3").innerHTML = boxesHtmlList.join("");

document.querySelector("#question4").innerHTML = albums.dogs.map((pic) => {
  return `<img src=${pic}">`
}).join('')
